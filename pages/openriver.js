      ...
      <div className="w-screen h-[50vh] relative">
        <div className="w-screen h-[50vh] relative">
          ...
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
            <h2 className="py-2">Open River MarketPlace</h2>
            <h3> </h3>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <p className="py-3">
              <b>
              Building a NFT Marketplace where, user can Create collection, Mint NFT, List them from Sale, De-List from Marketplace and Buy NFTs listed by others.
              </b>{" "}
              <br />
            ...
            <a href="https://open-river-market-place.vercel.app/" target="_blank">
              <button className="px-8 py-2 mt-4 mr-8">Demo</button>
            </a>

            <a href="https://github.com/shiv8115/OpenRiverMarketPlace" target="_blank">
